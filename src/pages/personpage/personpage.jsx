...
function PersonPage() {
    ...
    const [visibleMoviesCrew, setVisibleMoviesCrew] = useState(10);
    ...
    const loadMoreMoviesCrew = () => {
        setVisibleMoviesCrew(prev => prev + 10);
    };
    ...
    const moviesToShow = person.credits.cast.slice(0, visibleMovies);
    const hasMoreMovies = visibleMovies < person.credits.cast.length;

    const moviesCrewToShow = person.credits.crew.slice(0, visibleMoviesCrew);
    const hasMoreMoviesCrew = visibleMoviesCrew < person.credits.crew.length;
    ...
    return (
        <div>
            ...
            <div className='person-movies'>
                ...
                {hasMoreMovies && (
                    <button onClick={loadMoreMovies} className="voir-plus">
                        Voir plus
                    </button>
                )}
            </div>
            <div className="person-movies-crew">
                ...
                {hasMoreMoviesCrew && (
                    <button onClick={loadMoreMoviesCrew} className="voir-plus">
                        Voir plus
                    </button>
                )} 
